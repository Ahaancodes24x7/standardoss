...
function HomePage() {
  const featuredResult = searchResults[0];
  if (!featuredResult) return null;
  return <>
    <section className="page-wrap grid min-h-[42rem] items-center gap-10 py-12 lg:min-h-[46rem] lg:grid-cols-[1.02fr_.98fr] lg:py-16">
